    ...
    useEffect(() => {
        const handleAppearance = () => {
            ...
            progressBars.forEach(progressBar => {
                ...
                // Guard: skip if not found
                if (!progressContent || !progressNumberMark) return;
                ...
                const animateProgressNumberMark = (num) => {
                    ...
                    const percentElem = progressNumberMark.querySelector('.percent');
                    if (percentElem) percentElem.innerHTML = data + '%';
