export default function Chartview() {
    return (
        <>
            <section id="chart" className="tf-section tf_chart" style={{marginTop: '140px', marginBottom: '80px'}}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="tf-title" data-aos="fade-up" data-aos-duration={800} style={{marginBottom: '40px'}}>
                                <h2 className="title">
                                    Ugly Dog Chart View
                                </h2>
                            </div>
                        ...
                        <div className="col-md-12">
                            <div className="chart-wrapper style3" data-aos="fade-up" data-aos-duration={800} style={{borderRadius: '12px', overflow: 'hidden'}}>
